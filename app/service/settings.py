...
def seg_settings_to_dict(seg_settings):
    seg_settings_dic = {
        ...
        "word_frequency_adjust_data": seg_settings.word_frequency_adjust_data,
...
def seg_settings_to_data(window):
    ...
    window.seg_settings_datas.word_frequency_adjust_data = data["word_frequency_adjust_data"]
